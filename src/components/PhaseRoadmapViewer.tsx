...
export function PhaseRoadmapViewer() {
  const phases = [
    ...
    {
      number: 9,
      title: 'Asistente Fitness con IA (FitAdapt AI)',
      status: 'COMPLETADA',
      icon: Bot,
      description: 'Capa asistiva contextual y segura, con 7 herramientas estructuradas, filtro médico para dolor agudo, fallback determinista local, gestión de privacidad granular y 11 tests automatizados.',
      isCurrent: true,
    },
    {
      number: 10,
